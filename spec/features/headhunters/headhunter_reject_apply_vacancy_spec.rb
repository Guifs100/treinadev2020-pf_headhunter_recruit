...
feature 'Headhunter reject apply vacancy' do
  ...
  scenario 'successfully' do
    ...
    expect(page).not_to have_content(other_profile.full_name)
    expect(page).not_to have_content(other_profile.formation)
    expect(page).not_to have_content(other_profile.apply_vacancy.message)
